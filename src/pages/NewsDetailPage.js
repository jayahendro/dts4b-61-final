...
const NewsDetailPage = () => {
  ...
  useEffect(() => {
    axios
      .get(
        `https://api.nytimes.com/svc/search/v2/articlesearch.json?begin_date=${date}&end_date=${date}&q=${kategoripath}&sort=relevance&api-key=6zIrHoWJysSrtp26iKtuu07A6Lr5jtSO`
